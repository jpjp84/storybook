...
function renderBlockHeader(children, level) {
  switch (level) {
    case 1:
      return <p
        className="nso-header-1 has-text-primary has-background-white-bis subtitle is-2">{children}</p>;
    case 2:
      return <p
        className="nso-header-2 has-text-primary has-background-white-bis subtitle is-3">{children}</p>;
    case 3:
    default:
      return <p
        className="nso-header-3 has-text-primary has-background-white-bis subtitle is-5">{children}</p>;
  }
}
...
const Index = ({ data, renderer, debug }) => {
